...
public class BlockBlazeInfusedLog extends BlockWoodBase implements ITileEntityProvider{
    public BlockBlazeInfusedLog(String name, Material materialIn) {
        super(name, materialIn);
        tooltipText.add("Carve with the Carving Tool to create");
        tooltipText.add("a Blaze Totem Head");
    }
